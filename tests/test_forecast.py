...
from tools.modeling.anchored_features import (FEATURE_COLUMNS, MODEL_COLUMNS, build_features, clean_analyser,
...
def test_last_lab_age_is_measured_from_sampling():
    from tools.modeling.anchored_features import available_lab
...
def test_portable_raw_fusion_respects_convex_hull_and_floors_negative_regression():
    from tools.modeling.anchored_features import predict_portable
